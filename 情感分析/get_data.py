...
class Spidermaoyan():
    headers = {
        ...
        "Host": "m.maoyan.com",
                "Referer": "http://m.maoyan.com/movie/1292/comments?_v_=yes"
    }
    ...
    def file_do(self, list_info):
        # 获取文件大小
        file_size = os.path.getsize(r'C:\Users\think\Desktop\情感分析\doc\maoyan1.csv')
        if file_size == 0:
            # 表头
            ...
            # 数据写入
            file_test.to_csv(r'C:\Users\think\Desktop\情感分析\doc\maoyan1.csv',
                             encoding='utf_8_sig', index=False)
        else:
            with open(r'C:\Users\think\Desktop\情感分析\doc\maoyan1.csv', 'a+',
...
def spider_maoyan():
    ...
    while start_time > end_time:
        comment_api = 'http://m.maoyan.com/mmdb/comments/movie/1292.json?_v_=yes&offset=15&startTime=' + start_time.replace(' ', '%20')
